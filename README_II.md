...
Lors de la [première partie](README.md) nous étions arrivés à ce code pour convertir le nombre en chiffres romains de 1 à 13. Uniquement avec une démarche basée sur des tests, des ajouts successifs, des ré-écritures.
