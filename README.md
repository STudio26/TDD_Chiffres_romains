...
Dans un [prochain article](README_II.md) on ira au delà de *XIII*, toujours avec la même méthode. Si vous voulez essayer par vous même, allez-y et faites moi part de votre retour d'expérience.
